...
function calculateNHIFDeductions(grossPay){
    const nhifRates = [
        {limit:6699, deduction: 50},
        {limit:22199, deduction: 300},
        {limit:33999, deduction: 750},
        {limit:220000, deduction: 1600},
...
function calculateNetSalary(basicSalary, benefits){
    ...
    //calc NSSF deduction based on basic
...
function getUserInput(question){
 ...
 async function run(){
    ...
    console.log("NSSF Deduction = ", salaryDetails.NSSFDeductions);
